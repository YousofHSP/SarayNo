        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Activities_CostGroups_CostGroupId",
                        column: x => x.CostGroupId,
                        principalTable: "CostGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Activities_Creditors_CreditorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Invoices_CostGroups_CostGroupId",
                        column: x => x.CostGroupId,
                        principalTable: "CostGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InvoiceLogs_AspNetUsers_CreatorUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceLogs_CreatorUserId",
                table: "InvoiceLogs",
